...
var defaultSysVars = []*SysVar{
	...
	{Scope: vardef.ScopeGlobal | vardef.ScopeSession, Name: vardef.TiDBEnableSelectSkipLocked, Value: BoolToOnOff(vardef.DefTiDBEnableSelectSkipLocked), Type: vardef.TypeBool, SetSession: func(s *SessionVars, val string) error {
		s.EnableSelectSkipLocked = TiDBOptOn(val)
		return nil
	}},
